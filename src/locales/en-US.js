export default {
  ...
  'nodeTask': 'Node Task',
  'nodeTask.nodeJs': 'Node Js',
  'javasTask': 'Javas Task',
  'javasTask.javasClass': 'Javas Class Name',
  'androidTask': 'Android Task',
  'androidTask.android': 'Android',
  'dockerTask': 'Docker Task',
  'dockerTask.docker': 'Docker',
  'mailTask': 'Mail Task',
  'mailTask.to': 'To',
